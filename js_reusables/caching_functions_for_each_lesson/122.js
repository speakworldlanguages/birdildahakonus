...
async function cacheAssetsOfLesson122() {

  const cacheSlot0 = await caches.open('primary-assets-for-1-2-2');
  const cacheSlot1 = await caches.open('secondary-assets-for-1-2-2');
  ...
  try {
    parent.console.log("Caching files for 1-2-2 ...");
    ...
    if (!errorHappened) {
      parent.console.log("... and files for 1-2-2 were cached successfully");
      localStorage.loadFiles122WasSuccessful = "cool";
    }
  }

} // END OF cacheAssetsOfLesson122

cacheAssetsOfLesson122();
