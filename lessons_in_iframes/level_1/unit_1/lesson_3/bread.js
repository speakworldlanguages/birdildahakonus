...
const say1say2Path = "/audio_files_for_listening/"+parent.langCodeForTeachingFilePaths+"/level_1/unit_1/lesson_3/bread_1-2.webm";
const say3Path     = "/audio_files_for_listening/"+parent.langCodeForTeachingFilePaths+"/level_1/unit_1/lesson_3/bread_3.webm";
const say4say5Path = "/audio_files_for_listening/"+parent.langCodeForTeachingFilePaths+"/level_1/unit_1/lesson_3/bread_4-5.webm";
const say6Path     = "/audio_files_for_listening/"+parent.langCodeForTeachingFilePaths+"/level_1/unit_1/lesson_3/bread_6.webm";
const say7say8Path = "/audio_files_for_listening/"+parent.langCodeForTeachingFilePaths+"/level_1/unit_1/lesson_3/bread_7-8.webm";
...
//const whatBreadSoundsLike1 = new parent.Howl({  src: ["/lessons_in_iframes/level_1/unit_1/lesson_3/what_bread_sounds_like_1.webm"]  });
//const whatBreadSoundsLike2 = new parent.Howl({  src: ["/lessons_in_iframes/level_1/unit_1/lesson_3/what_bread_sounds_like_2.webm"]  });
//3
//4
//5
...
function stopListeningAndProceedToNext() {
  ...
  if (!userHasGivenUp) { // User was successful with speech recognition
    ...
    parent.savedProgress[studiedLang].lesson_BREAD_IsCompleted=false; // WATCH THE NAME OF THE LESSON!!!
  }
  parent.saveJSON = JSON.stringify(parent.savedProgress); // Convert
  localStorage.setItem("memoryCard", parent.saveJSON); // Save
