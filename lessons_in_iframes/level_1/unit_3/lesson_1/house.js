...
const filePathForTheWordOrPhrase = "../../../../speech_recognition_dictionary/"+parent.theLanguageUserIsLearningNowToSetFilePaths+"/1-3-1-house.txt";
...
const say1say2Path = "audio_files_for_listening/"+parent.theLanguageUserIsLearningNowToSetFilePaths+"/level_1/unit_3/lesson_1/house_1-2.mp3";
const say3say4Path = "audio_files_for_listening/"+parent.theLanguageUserIsLearningNowToSetFilePaths+"/level_1/unit_3/lesson_1/house_3-4.mp3";
const say5say6Path = "audio_files_for_listening/"+parent.theLanguageUserIsLearningNowToSetFilePaths+"/level_1/unit_3/lesson_1/house_5-6.mp3";
const say7say8Path = "audio_files_for_listening/"+parent.theLanguageUserIsLearningNowToSetFilePaths+"/level_1/unit_3/lesson_1/house_7-8.mp3";
...
function loadingIsCompleteFunction()
{
  ...
  if (parent.theLanguageUserIsLearningNowToSetFilePaths == "zh") { // Fangzi or Jia
